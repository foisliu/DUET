...
####
hdu = fits.open('/Users/liuxihe/Desktop/DUET/DUET_figure_2/SgrB1off_band3_cont_rebin30.image.tt0.regrid2b6.new.fits')[0]
hdu_pbcor = fits.open('/Users/liuxihe/Desktop/DUET/DUET_figure_2/SgrB1off_band3_cont_rebin30.image.tt0.regrid2b6.new.pbcor.fits')[0]
hdu.data = hdu.data * 1e3 # Convert to mJy/beam
hdu_pbcor.data = hdu_pbcor.data * 1e3 # Convert to mJy/beam
hdu_pb=fits.open('/Users/liuxihe/Desktop/DUET/DUET_figure_2/SgrB1off_band3_cont_rebin30.image.tt0.regrid2b6.new.pb.fits')[0].data
...
if (not os.path.isfile('sgrb1off_dendro_mask_band3.fits')) or owcat:
    mask = np.zeros(hdu.data.shape, dtype=bool)
    for leaf in leaves_repro:
        mask = mask | leaf.get_mask()
    
    newmask = np.array(mask, dtype=int)
    fits.writeto('/Users/liuxihe/Desktop/sgrb1off_dendro_mask_band3.fits', newmask, hdu.header, overwrite=True)

    index_only3 = np.loadtxt('/Users/liuxihe/Desktop/DUET/DUET_data_2/only_band3.dat', usecols=(0,), dtype=int)
    leaves_only3 = []
    for i, leaf in enumerate(leaves_repro):
        if i in index_only3:
    ...
    fits.writeto('/Users/liuxihe/Desktop/sgrb1off_dendro_mask_only_band3.fits', newmask_only3, hdu.header, overwrite=True)
    ...
    mask_hdu = fits.open('sgrb1off_dendro_mask_band3.fits')[0]
...
f1.colorbar.set_ticks([0.02,0.05,0.1,0.2,0.5,1,2])
...
f1.set_title('$I_\mathrm{3\,mm}$ (mJy/beam)')
...
f1.save('/Users/liuxihe/Desktop/sgrb1off_cores_band3.pdf',dpi=150)
