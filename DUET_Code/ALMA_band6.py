...
hdul = fits.open('/Users/liuxihe/Desktop/DUET_figure_2/sgrb1off_south_cont_selfcal.commonbeam.image.fits')[0] 
data = hdul.data * 1e3 
...
f1.show_colorscale(cmap='inferno', vmax=0.0007605013586212759, vmin=-0.0001645501762168187, aspect='equal')
...
f1.colorbar.set_ticks([-0.0002,0,0.0002,0.0004,0.0006,0.0008])
f1.colorbar.set_axis_label_pad(15)

f1.set_title('ALMA_band6 after smoothing')

f1.save('/Users/liuxihe/Desktop/ALMA_band6.pdf',dpi=150)
